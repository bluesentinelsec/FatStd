 ...
 *
 * This module is backed by Go's compress/gzip package.
 *
 * Design notes:
 ...
 */
FATSTD_API fat_Status fat_GzipCompress(fat_Bytes src, fat_Bytes *out, fat_Error *out_err);
 ...
 */
FATSTD_API fat_Status fat_GzipDecompress(fat_Bytes src, fat_Bytes *out, fat_Error *out_err);
